...
public class MyAppointmentsFragment extends Fragment {
    ...
    private RecyclerView rvMyAppointent;
    private DB snaapyDb;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ViewGroup rootView = (ViewGroup) inflater.inflate(
                R.layout.fragment_my_appointment, container, false);
        return rootView;
    }
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        rvMyAppointent = (RecyclerView) view.findViewById(R.id.rvMyAppointent);
        RecyclerView.LayoutManager mLayoutManager = new LinearLayoutManager(getActivity());
        rvMyAppointent.setLayoutManager(mLayoutManager);
        rvMyAppointent.setItemAnimator(new DefaultItemAnimator());
        loadData();
    ...
    private void loadData() {
        try {
            double currTime = SystemClock.currentThreadTimeMillis();
            ...
            adapter = new AppointmentRequestAdapter(getActivity(), patients, AppConstants.MY_APPOINTMENTS);
            rvMyAppointent.setAdapter(adapter);
