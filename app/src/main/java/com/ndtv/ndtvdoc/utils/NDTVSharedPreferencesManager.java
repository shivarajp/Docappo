package com.ndtv.ndtvdoc.utils;
 ...
 */
public class NDTVSharedPreferencesManager {

    public static final String USER_DATA_STORED = "user_data";
    public static final String NDTV_APP_PREFERENCE = "com.ndtv.ndtvdoc";
    public static final String PATIENT_DETAILS = "patentDetails";
    public static final String PATIENTS = "patents";
    ...
    public static SharedPreferences getPreferenceObject(Context context) {
        SharedPreferences preferences = context.getSharedPreferences(
                NDTV_APP_PREFERENCE, Context.MODE_PRIVATE);
        return preferences;
    }

    public static SharedPreferences.Editor getPreferencesEditor(Context context) {
        SharedPreferences.Editor editor = context.getSharedPreferences(NDTV_APP_PREFERENCE, Context.MODE_PRIVATE).edit();
        return editor;
    }
}